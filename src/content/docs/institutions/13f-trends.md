...
- 基本面多头/对冲型：Altimeter=1.1, Baillie=1.1, Oaktree=0.9, ARK=1.0, Third Point=1.0, Greenlight=1.0, Baupost=1.1, Lone Pine=1.0, Maverick=0.9, Oakmark=1.1。
