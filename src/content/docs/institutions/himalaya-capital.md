---
title: "Himalaya Capital"
slug: "institutions/himalaya-capital"
description: "Himalaya Capital 的机构级哲学、文化与传承。"
---
## 机构简介

Himalaya Capital 是李录于 1997 年创立的价值投资机构。官方公开表述很直接：机构遵循 Graham、Buffett、Munger 的价值投资原则，主要聚焦亚洲与北美公开市场中的长期机会，目标是成为 `high quality companies with substantial economic moat, great growth potential, and run by trust-worthy people` 的长期所有者。[Himalaya Capital 官方简介](https://www.himcap.com/)

这家机构在这批资料 里的意义，不是规模和持仓清单，而是它把李录的人物方法真正写进了制度：`对知识诚实`、`只在 fat pitch 出手`、`长期所有者`、以及 `trust-worthy people`。也正因为此，Himalaya 不是普通意义上的“华人价值基金”，而更像一台把 owner logic、长持和 deserved trust 组织化的机器。
...
公开信息显示，Himalaya 的客户主要是大学捐赠基金、基金会、家族办公室、个人和养老金计划，且合伙关系通常不向新资金开放，只会选择性和现有合伙人的推荐对象讨论。[Himalaya Capital 官方简介](https://www.himcap.com/)
...
- [李录](/investor-masters/investors/li-lu/): 机构的创始人和方法核心。
- [查理·芒格](/investor-masters/investors/charlie-munger/): 不是 Himalaya 的内部投资人，但在现有资料里是这套方法最重要的精神来源和长期外部影响者。

## 标志性公开材料

- [2021年李录与格林沃尔德深度对话：我们想投资的是那些可以在巨大不确定性中泰然处之的公司……](/investor-masters/sources/source-07/)：理解李录方法主线的核心材料。
- [李录亲述：为什么能拿住比亚迪23年？](/investor-masters/sources/source-129/)：理解机构如何把长期所有者逻辑落到具体公司上的最好样本。
- [李录最新交流剖析新秩序：通过“四两拨千斤”，中国还可以释放很多改革红利……](/investor-masters/sources/source-130/)：理解李录如何把资本市场与制度环境纳入投资框架。
...
- 持仓总市值从 `$3.20bn` 升至 `$3.70bn`，增加 `$501.7m`（`+15.7%`）。粗拆：主动变化约 `+$323.3m`，价格变化约 `+$178.4m`。
- 唯一大动作是 PDD 股数从 `4.61m` 增至 `10.76m`（`+133.5%`）；BRK.B 股数增加 `23.5%`，其余八大核心多数不动。
- 清仓 BAC、OXY、SPGI、HRB、MCO、MSCI，把 13F 从 `14` 只压到 `8` 只；前五大集中度升至 `94.8%`。
...
- `GOOGL`：`24.55%`，约 `$908.9m`，股数 `2,543,300`，较上季不变。
- `GOOG`：`23.39%`，约 `$866.1m`，股数 `2,451,300`，较上季不变。
- `PDD`：`22.17%`，约 `$820.9m`，股数 `10,761,119`，较上季 `+133.5%`。
- `BRK.B`：`14.98%`，约 `$554.6m`，股数 `1,108,318`，较上季 `+23.5%`。
- `EWBC`：`9.68%`，约 `$358.4m`，股数 `2,776,351`，较上季不变。
- `CROX`：`2.89%`，约 `$107.0m`，股数 `887,093`，较上季不变。
- `TME`：`1.49%`，约 `$55.0m`，股数 `6,590,836`，较上季不变。
- `AAPL`：`0.86%`，约 `$32.0m`，股数 `110,600`，较上季不变。
