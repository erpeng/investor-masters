---
title: "空头视角"
slug: "concepts/short-perspective"
description: "空头视角 在这批资料 里的最佳入口。"
---
## 定义
...
[托德·库姆斯](/investor-masters/investors/todd-combs/) 是当前材料里把这件事说得最硬的人。对他来说，做空首先是一种思维方式，因为它逼你同时看公司的两面：不只看收入和利润怎么长出来，也看负债、资本结构、错配和脆弱性会怎样把一个看似漂亮的故事拖垮。也正因为如此，托德的版本不该被理解成“更爱做空”，而应该被理解成 `即使不做空，也不能失去空头式审问能力`。

[沃伦·巴菲特](/investor-masters/investors/warren-buffett/) 和 [查理·芒格](/investor-masters/investors/charlie-munger/) 则提供了最重要的对照。他们最终放弃的，是做空这种极难、极反人性的交易动作；但他们并没有放弃从反面看问题的能力。巴菲特式能力圈、芒格式避免愚蠢，本质上都保留了空头视角的一部分，只是把它折叠进边界纪律，而不再把它变成实际仓位。
