...
如果你想快速知道“我为什么要读这个人”，从人物页开始；如果你想知道“为什么同一家公司会被不同方法反复提到”，去公司页；如果你想理解“为什么有的人能长期持有，有的人根本做不到”，读机构页。如果你已经带着一个明确问题来，比如“优势从哪里来”“什么坚决不碰”“怎样判断管理层”，就直接从 [投资十问](/investor-masters/ten-questions/index/) 开始。
...
- [对话与争议总览](/investor-masters/dialogues/): 把分散在人物页里的张力显性化。
- [质量价值 vs 成长非共识](/investor-masters/dialogues/quality-vs-growth/): 特里·史密斯与詹姆斯·安德森的对照。
- [保守的风险语言 vs 激进的仓位语言](/investor-masters/dialogues/risk-and-conviction/): 马克斯与德鲁肯米勒的风险分歧。
- [不懂不碰 vs 未来信息才重要](/investor-masters/dialogues/certainty-vs-future/): 段永平与比尔·米勒的认识论分歧。
- [看懂边界 vs 品味判断](/investor-masters/dialogues/boundary-vs-taste/): 段永平与纳瓦尔关于判断从哪里来的分歧。

## 最近更新

- `2026-04-09` 阅读结构升级：人物页现在更回答“为什么这样投”，投资十问则专门负责横向审问。
- `2026-04-09` 投资十问更新：组合构建和系统性误判两组答案被补强了。
- `2026-04-09` 投资十问更新：优势问题下的关键答案重新收紧了。
- `2026-04-09` 投资十问更新：一些答案被重写得更锋利，也更能看出彼此差异。
- `2026-04-09` 投资十问和公司页一起收紧了，现在答案和引言更贴原始材料。
- `2026-04-09` 新增投资十问，并把公司页扩到更完整的一批。
- `2026-04-08` 更新公司：苹果、SpaceX，两页的纳瓦尔引言重写。
- `2026-04-08` 更新公司：苹果、SpaceX；新增对话：看懂边界 vs 品味判断。
