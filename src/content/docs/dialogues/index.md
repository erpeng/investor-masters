...
title: "对话与争议"
slug: "dialogues"
description: "对比会逼迫读者形成自己的判断。"
---
# 对话与争议

这里不是“再看一遍人物摘要”，而是把本来分散在不同人物页里的张力压到同一张桌子上。读人物页，你会知道他们各自怎么想；读对话页，你会更快看清自己更接近哪一种方法，愿意承受哪一种错误。
...
- [复利信仰 vs 流动性信仰](/investor-masters/dialogues/compound-faith-vs-liquidity-faith/): 如果你总分不清一个位置应该用长期复利心态拿住，还是应该先保护流动性和退出权。
- [永久复利 vs 七年价值重估](/investor-masters/dialogues/permanent-compounding-vs-seven-year-revaluation/): 如果你总在“伟大公司应该一直拿着”和“涨到目标价值就该卖”之间摇摆。
- [审计式质量 vs 艺术式质量](/investor-masters/dialogues/audit-quality-vs-art-quality/): 如果你总在“质量必须能被硬指标审计”和“质量还需要长期判断力识别”之间摇摆。
- [少犯错游戏 vs 多赢家游戏](/investor-masters/dialogues/fewer-losers-vs-more-winners/): 如果你还没想清楚，自己玩的到底是信用式少犯错游戏，还是股票/VC 式少数赢家游戏。
...
- [静态能力圈 vs 可审计能力圈](/investor-masters/dialogues/static-vs-auditable-circle/): 如果你总在“我觉得我懂”与“我能证明自己真的懂”之间摇摆。
- [交易型反脆弱 vs 资本结构型反脆弱](/investor-masters/dialogues/trading-vs-capital-structure-antifragility/): 如果你开始意识到，很多错误不是看错，而是结构太脆。
- [政策底 vs 估值底](/investor-masters/dialogues/policy-put-vs-valuation-floor/): 如果你总在“资产已经便宜”和“政策真的改变了价格分布”之间分不清。
...
- [制度保护时间 vs 性格保护时间](/investor-masters/dialogues/institution-vs-temperament/)
- [复制优秀模式 vs 寻找超级赢家](/investor-masters/dialogues/cloning-vs-super-winners/)
- [提问式判断 vs 仓位式判断](/investor-masters/dialogues/questioning-vs-positioning/)
- [静态能力圈 vs 可审计能力圈](/investor-masters/dialogues/static-vs-auditable-circle/)
- [交易型反脆弱 vs 资本结构型反脆弱](/investor-masters/dialogues/trading-vs-capital-structure-antifragility/)
