...
[比尔·阿克曼](/investor-masters/investors/bill-ackman/) 已经把一件事讲得很透: 方向判断正确，不代表交易结构不会先把你打死。[托德·库姆斯](/investor-masters/investors/todd-combs/) 则把问题再往前推了一步: 很多脆弱性其实在你下单前就已经写在负债端、融资结构和时间错配里，只是大多数人只看了半张资产负债表。[特蕾西·布里特·库尔](/investor-masters/investors/tracy-britt-cool/) 和 [Berkshire Hathaway](/investor-masters/institutions/berkshire-hathaway/) 最后再站到更前面一步提醒你: 真正更强的反脆弱，不是进场后才想怎么扛，而是一开始就把资本结构和组织结构设计成不容易被迫犯错。
...
很多投资人说自己重视风险，但脑子里只有价格波动和止损线，没有资本结构。结果就是，明明 thesis 还活着，却因为杠杆、融资、赎回、或公司短期偿债压力，被迫在最差的时候做最差的动作。更糟的是，很多人甚至直到出事前都没认真看过负债端。
